(function (a) {
  "use strict";
  function b() {
    var b = a(".portfolio-grid"),
      c = a(".portfolio-filters");
    b &&
      (b.shuffle({ speed: 450, itemSelector: "figure" }),
      c.on("click", ".filter", function (c) {
        b.shuffle("update"),
          c.preventDefault(),
          a(".portfolio-filters .filter").parent().removeClass("active"),
          a(this).parent().addClass("active"),
          b.shuffle("shuffle", a(this).attr("data-group"));
      }));
  }
  function c() {
